...
public class Account {
	...
	@DatabaseField(columnName = "clean_session", canBeNull = true)
	private boolean cleanSession;
	@DatabaseField(columnName = "keep_alive", canBeNull = true)
	private int keepAlive;
	@DatabaseField(canBeNull = true)
	private String will;
	@DatabaseField(columnName = "will_topic", canBeNull = true)

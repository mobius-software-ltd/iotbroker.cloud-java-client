...
{
	private ConnectionListener<AMQPHeader> listener;

	public AMQPHandler(ConnectionListener<AMQPHeader> listener)
	{
		this.listener = listener;
	}

	@Override protected void channelRead0(ChannelHandlerContext channelHandlerContext, AMQPHeader mqMessage)
			throws Exception
	{
